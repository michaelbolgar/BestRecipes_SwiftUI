...
extension RecipeModel {
    static let mockDataRecipeModel: [RecipeModel] = [
        RecipeModel(
            id: 1,
    ...
    static var trendingMockBookable: [RecipeModel] {
        Array(mockDataRecipeModel.prefix(3))
    }
    
    /// Моковые данные для популярных категорий
    static var popularCategoryMock: [RecipeModel] {
        Array(mockDataRecipeModel.suffix(3))
    }
